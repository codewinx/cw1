...
export default function HandworkerSidebar({ open, setOpen }) {
  const menuItems = [
    ...
    { icon: FileText, label: "New Tasks", path: "/handworker/newtasks" },
    { icon: Clock, label: "In-Progress", path: "/handworker/inprogresstasks" },
    { icon: CheckCircle, label: "Completed", path: "/handworker/completedtasks" },
  ];
