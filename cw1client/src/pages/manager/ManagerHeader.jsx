        ...
        <div className="flex items-center space-x-8 relative">
          ...
          <div className="relative">
            <div
              ...
              className="flex items-center space-x-4 bg-white rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition duration-300 cursor-pointer"
            >
            ...
            {/* Dropdown menu */}
            {menuOpen && (
              <div className="absolute right-0 mt-3 w-48 bg-white shadow-lg rounded-xl py-2 z-50">
                <button
