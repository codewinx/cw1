...
const CutterSidebar = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/cutter/CutterTasks") setTaskCounts((prev) => ({ ...prev, pending: 0 }));
    else if (location.pathname === "/cutter/CutterInprogress") setTaskCounts((prev) => ({ ...prev, inProgress: 0 }));
    else if (location.pathname === "/cutter/CutterCompleted") setTaskCounts((prev) => ({ ...prev, done: 0 }));
  }, [location.pathname]);
    ...
    <>
      ...
      <div className="lg:hidden border-b flex items-center">
        <button
          ...
          className="lg:hidden fixed top-4 left-1 z-50 p-2 rounded-md bg-white shadow-md"
        >
